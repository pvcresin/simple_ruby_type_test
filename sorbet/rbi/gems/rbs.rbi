...
module RBS::DetailedMessageable
  def detailed_message(highlight: nil, **arg1); end
end
...
module RBS::FileFinder
  def self.each_file(path, immediate:, skip_hidden:, &block); end
end
module RBS::AST
end
...
class RBS::DefinitionBuilder
  ...
  def define_method(methods, definition, method, subst, defined_in:, implemented_in: nil); end
