...
class Steep::Diagnostic::Ruby::UnreachableValueBranch < Steep::Diagnostic::Ruby::Base
  def header_line; end
  def initialize(node:, type:, location: nil); end
  def type; end
end
...
class Steep::Diagnostic::Ruby::IncompatibleArgumentForwarding < Steep::Diagnostic::Ruby::Base
  def block_pair; end
  def header_line; end
  def initialize(method_name:, node:, result:, params_pair: nil, block_pair: nil); end
  def method_name; end
  def params_pair; end
  def result; end
...
class Steep::Source
  ...
  def initialize(buffer:, path:, node:, mapping:, comments:); end
  def mapping; end
  def node; end
  def path; end
...
class Steep::AnnotationParser
  ...
  def parse_type(match, name = nil, location:); end
end
class Steep::AnnotationParser::SyntaxError < StandardError
  def initialize(source:, location:, exn: nil, message: nil); end
  def location; end
  def source; end
end
class Steep::Typing
...
class Steep::TypeConstruction
  ...
  def propagate_type_env(source, dest, env); end
  ...
  def transform_condition_node(node, var_name); end
  ...
  def type_send(node, send_node:, block_params:, block_body:, tapp:, hint:, unwrap: nil); end
...
class Steep::TypeInference::ContextArray
  ...
  def range; end
  def root; end
  def self.from_source(source:, context:, range: nil); end
end
...
class Steep::TypeInference::MethodParams
  ...
  def size; end
  def update(forward_arg_type: nil); end
end
...
class Steep::TypeInference::LogicTypeInterpreter
  ...
  def evaluate_node(env:, node:, type: nil); end
  def factory; end
...
class Anonymous_Struct_1 < Struct
  ...
  def type=(_); end
  def unreachable; end
  def unreachable=(_); end
end
class Steep::TypeInference::LogicTypeInterpreter::Result < Anonymous_Struct_1
  def unreachable!; end
  def update_env; end
  def update_type; end
end
...
class Steep::Index::SignatureSymbolProvider::SymbolInformation < Anonymous_Struct_2
end
...
class Steep::Services::TypeNameCompletion
  def context; end
  def each_outer_module(context = nil, &block); end
...
class Anonymous_Struct_3 < Struct
  def absolute_type_name; end
  def absolute_type_name=(_); end
  def env; end
  def env=(_); end
  def range; end
  def range=(_); end
  def relative_type_name; end
  def relative_type_name=(_); end
  def self.[](*arg0); end
  def self.inspect; end
  def self.members; end
  def self.new(*arg0); end
end
class Steep::Services::CompletionProvider::TypeNameItem < Anonymous_Struct_3
  def comments; end
  def decl; end
end
...
class Steep::Services::StatsCalculator::SuccessStats < Anonymous_Struct_4
  def as_json; end
end
...
class Steep::Services::StatsCalculator::ErrorStats < Anonymous_Struct_5
  def as_json; end
end
...
class Steep::Services::GotoService::ConstantQuery < Anonymous_Struct_6
...
class Steep::Services::GotoService::MethodQuery < Anonymous_Struct_7
  include Steep::Services::GotoService::SourceHelper
end
...
class Steep::Services::GotoService::TypeNameQuery < Anonymous_Struct_8
end
module Steep::Server
end
...
module Steep::Server::LSPFormatter
  ...
  def format_comment(comment, header: nil, &block); end
  def format_comments(comments); end
  def format_completion_docs(item); end
  def format_hover_content(content); end
  def format_method_item_doc(method_types, method_names, comments, footer = nil); end
  ...
  def self.markup_content(string = nil, &block); end
...
class Steep::Server::Master::TypeCheckController::TargetPaths
  def <<(path, library: nil); end
  def add(path, library: nil); end
  def all_paths; end
...
class Anonymous_Struct_9 < Struct
  ...
  def start_position=(_); end
end
class Steep::Expectations::Diagnostic < Anonymous_Struct_9
